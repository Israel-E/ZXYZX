...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{url('home')}}" class="logo">
      ...
      <span class="logo-lg">Adminitracion</span>
    </a>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{url('/home')}}"><i class="fa fa-circle-o"></i> Administracion</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('form-publicacion')}}" class="paginacion"><i class="fa fa-circle-o"></i>Crear publicacion</a></li>
            <!--<li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i>Ver publicaciones</a></li>
            <li><a href="pages/layout/fixed.html"><i class="fa fa-circle-o"></i>Publicaciones por fecha</a></li>
