            ...
            <div class="container">
                ...
                <div class="row-fluid team">
                    <div class="span4" id="first-person">
                        <div class="thumbnail">
                            <img src="{{asset('images/Team1.png')}}" alt="team 1">
                            <h3>John Doe</h3>
                            <ul class="social">
                                <li>
                                    <a href="">
                    ...
                    <div class="span4" id="second-person">
                        <div class="thumbnail">
                            <img src="{{asset('images/Team2.png')}}" alt="team 1">
                            <h3>John Doe</h3>
                            <ul class="social">
                                <li>
                                    <a href="">
                    ...
                    <div class="span4" id="third-person">
                        <div class="thumbnail">
                            <img src="{{asset('images/Team3.png')}}" alt="team 1">
                            <h3>John Doe</h3>
                            <ul class="social">
                                <li>
                                    <a href="">
                    ...
                    <div class="row">
                        <div class="span4">
                            <div class="testimonial">
                                ...
                                <div class="whopic">
                                    <div class="arrow"></div>
                                    <img src="{{asset('images/Client1.png')}}" class="centered" alt="client 1">
                                    <strong>John Doe
                                        <small>Client</small>
                                    </strong>
                                </div>
                        ...
                        <div class="span4">
                            <div class="testimonial">
                                ...
                                <div class="whopic">
                                    <div class="arrow"></div>
                                    <img src="{{asset('images/Client2.png')}}" class="centered" alt="client 2">
                                    <strong>John Doe
                                        <small>Client</small>
                                    </strong>
                                </div>
                        ...
                        <div class="span4">
                            <div class="testimonial">
                                ...
                                <div class="whopic">
                                    <div class="arrow"></div>
                                    <img src="{{asset('images/Client3.png')}}" class="centered" alt="client 3">
                                    <strong>John Doe
                                        <small>Client</small>
                                    </strong>
                                </div>
            ...
            <div class="container centered">
                <div class="sub-section">
                    ...
                    <ul class="row client-slider" id="clint-slider">
                        <li>
                            <a href="">
                                <img src="{{asset('images/clients/ClientLogo01.png')}}" alt="client logo 1">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="{{asset('images/clients/ClientLogo02.png')}}" alt="client logo 2">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="{{asset('images/clients/ClientLogo03.png')}}" alt="client logo 3">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="{{asset('images/clients/ClientLogo04.png')}}" alt="client logo 4">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="{{asset('images/clients/ClientLogo05.png')}}" alt="client logo 5">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="{{asset('images/clients/ClientLogo02.png')}}" alt="client logo 6">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="{{asset('images/clients/ClientLogo04.png')}}" alt="client logo 7">
                            </a>
                        </li>
                    </ul>
                </div>
